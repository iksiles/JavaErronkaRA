...
public class faktura_amai extends JFrame{
	...
	public void faktura_amai() {
		getContentPane().setLayout(null);
		faktura_amai faktura_amaiframe = new faktura_amai();
		faktura_amaiframe.setBounds(0,0,692,550);
		faktura_amaiframe.setVisible(true);
		faktura_amaiframe.setResizable(false);
		faktura_amaiframe.setLocationRelativeTo(null);
	}
	...
	public void fakjarri() {
		...
		for (int i=0; i<login.amaiFakAL.size(); i++) {
			dlmlist3.addElement(login.amaiFakAL.get(i));
		}
	}
